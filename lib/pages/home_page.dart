      ...
      body:  FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          if (snapshot.hasData) {
            ...
            List<Map> swipDataList = (dataMap['slides'] as List).cast(); // 顶部轮播组件数
            List<Map> navigatorList =(dataMap['category'] as List).cast(); //类别列表

            String advertesPicture = dataMap['advertesPicture']['PICTURE_ADDRESS']; //广告图片

            String  leaderImage= dataMap['shopInfo']['leaderImage'];  //店长图片
            String  leaderPhone = dataMap['shopInfo']['leaderPhone']; //店长电话

            List<Map> recommendList = (dataMap['recommend'] as List).cast(); // 商品推荐

            String floor1Title =dataMap['floor1Pic']['PICTURE_ADDRESS'];//楼层1的标题图片
            String floor2Title =dataMap['floor2Pic']['PICTURE_ADDRESS'];//楼层1的标题图片
            String floor3Title =dataMap['floor3Pic']['PICTURE_ADDRESS'];//楼层1的标题图片
